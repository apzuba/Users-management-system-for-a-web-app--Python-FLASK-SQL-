...
code to get the bomb out. Write the code to stop the bomb. The code is 3 digits.
""")
...
escape_pod.add_hints([("The paired numbers are the lucky ones...")])
...
the_bridge.add_hints([("throw the bomb"), ("slowly place the bomb")])
...
laser_weapon_armory.add_hints([ ("0123"), ("1203"), ("0132"), ("2103") ])
...
central_corridor.add_hints([ ('shoot!'), ('dodge!'), ("tell a joke") ])
